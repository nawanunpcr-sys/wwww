...
//
// ── ถอดออก 2026-08-21 · ห้ามใส่กลับโดยไม่ทดสอบก่อน ────────────────────────────
// ลิสต์นี้ต่างจาก TRUSTED_DOMAINS ของ Skill 3 ตรงที่ "เราเป็นคน fetch เอง" (ดู :377)
// โดเมนที่ดึงไม่ได้จึงไม่ได้แค่เสียเปล่า แต่ทำให้ fetch โยน error ออกมาเป็น 500
// ทั้งที่ UI เพิ่งบอกผู้ใช้ไปว่าวางลิงก์จากเว็บนี้ได้ · ตัดออกแล้วได้ 400 ที่อ่านรู้เรื่องแทน
//   dlpw.go.th          → ENOTFOUND ทั้ง apex และ www
//   krisdika.go.th      → ENOTFOUND (apex ไม่มี A record)
//   www.krisdika.go.th  → DEPTH_ZERO_SELF_SIGNED_CERT
// krisdika ตรงกับที่ api/_lib/law-source.js บันทึกไว้แล้วว่าห้ามใส่กลับเข้ามา
// ที่นี่พลาดไปเพราะเป็นคนละลิสต์กัน · ตัวบทกฤษฎีกาหาได้จาก ratchakitcha.soc.go.th แทน
const ALLOWED_HOSTS = [
